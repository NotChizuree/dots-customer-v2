...
const TenantSelectorScreen = ({navigation}) => {
    ...
    const tenantsData = [
        {id: 1, name: 'BPR Kreasi Nusantara', address: 'Casablanca East', ljkType: 'BPR'},
        {id: 2, name: 'BPR Maliki Subur Sejahtera', address: 'Jalan Durian', ljkType: 'BPR'},
            ...
            {value && tenantsData.map((val, key) => {
                return (
                    <>
                        ...
                        right={() => <Button onPress={() => handleTenantSelector(val)}>Pilih</Button>}
                        />
                        <Divider />
                    </>
                )
